...
// simulation state (r/o)
	...
	string sDefine;	// -d name from the command line
...
#define FIRSTINITRUN (1<<27)	// Very first run in a multi-cycle script.
#define SHORTED	(1<<28)	// Short trades have been opened
#define AFFIRMED	(1<<29)	// [Ok] clicked on nonmodal message box
